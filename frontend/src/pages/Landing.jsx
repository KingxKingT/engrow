  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--color-bg)', padding: '2rem' }}>
      <div style={{ textAlign: 'center', maxWidth: '520px' }}>
        <div style={{ fontFamily: 'var(--font-serif)', fontSize: '42px', color: 'var(--color-primary)', letterSpacing: '-0.03em', marginBottom: '1rem' }}>Engrow</div>
        ...
        <p style={{ color: 'var(--color-text-secondary)', fontSize: '16px', lineHeight: 1.75, marginBottom: '2rem' }}>Adaptive lessons per skill. Honest placement. AI that speaks at your level and grows with you.</p>
        ...
        <p style={{ marginTop: '1.25rem', fontSize: '13px', color: 'var(--color-text-tertiary)' }}>Free. No credit card required.</p>
      </div>
    </div>
  );
}
